 ...
 */
public abstract class BeerBaseLexer extends Lexer
{
    /**
    ...
    public BeerBaseLexer(CharStream input) {
        super(input);
    }
    ...
    {
        if (lastToken == null || lastToken.getType() == BeerLexer.OpenBrace)
        {
            String text = getText();
    ...
    protected boolean IsRegexPossible() {
        ...
        switch (this.lastToken.getType()) {
            case BeerLexer.Identifier:
            case BeerLexer.NullLiteral:
            ...
            case BeerLexer.PlusPlus:
            case BeerLexer.MinusMinus:
